...
/**
 * @param string $path
 * @param string $fistPath
 * @param bool $time
 * 
 * @return string
 */
function asset(string $path, string $toPath = 'views/assets', $time = true): string
{
    $file = SITE['root'] . "/{$toPath}/{$path}";
    $fileOnDir = dirname(__DIR__, 1) . "/{$toPath}/{$path}";
